...
#lr1 = lrn("regr.compboost", stop_patience = 10L, stop_epsylon_for_break = 1e-5, learning_rate_univariat = 0.01,
  #learning_rate_interactions = 0.1, max_minutes_univariat = 2L, max_minutes_interaction = 2L, show_output = TRUE,
  #ntop_interaction = 20L, iters_max_univariat = 20000L,  iters_max_interactions = 20000L)

#lr1$train(tsk("boston_housing"))
#pred = lr1$predict(tsk("boston_housing"))
